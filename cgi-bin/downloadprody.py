...
<center>
      ...
      <tr>
<td><center><a href="/cgi-bin/urlfake.py" ><bold><font color="#7642A3">FAKE USERS(LIST)</font></bold></a></center></td>
<td><center><a href="/cgi-bin/urlplotuser.py" ><bold><font color="#7642A3">FAKE USERS(PLOT)</font></bold></a></center></td>
</tr>
     <tr><td><center><a href="/cgi-bin/urlfakereview.py" ><bold><font color="#7642A3">FAKE REVIEWS(LIST)</font></bold></a></center></td>

<td><center><a href="/cgi-bin/urlplotreview.py" ><bold><font color="#7642A3">FAKE REVIEWS(PLOT)</font></bold></a></center></td>     </tr>
    </table>
     </center>
    
      <center><a href="/cgi-bin/recommend1.py" ><bold><font color="#7642A3">SAMPLE REVIEWS</font></bold></a></center>
...
class MySpiderd(Spider):
    ...
    def par_ur(self,response):
         ...
         csk = csv.writer(open("REVDET.csv", "wb"))
