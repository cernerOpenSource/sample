          ...
          <!--left panel start --><!--left panel end -->
           <!--mid panel start --><!--mid panel end -->
            <!--right panel start --><!--right panel end -->
                ...
                <blockquote>
                <blockquote>
                <form enctype="multipart/form-data" action="/cgi-bin/downloadprody.py" method="post"><fieldset><legend><p style="font-family:arial;color: #077733;font-size:18px;">UPLOAD LINK</p></legend>
         <font color="#7642A3" size="+2"> <b>Hello """+a+"""</font></b><a href="/homepage.html" ><img src='/exit.jpg' align='right'></a><a href="/uploadfile.py"><img src='/back.jpg' align='right'></a> 
                <br><center>
                        <br class="spacer" />
         <br class="spacer" />
            <p><b><font color="#7642A3">URL of the product(FLIPKART) :</font></b><input type="text" name="link"></p><br>
            <br>
